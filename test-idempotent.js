        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, snaptrade.authentication.registerSnapTradeUser({ userId: "test-user-xyz" })];
                case 1:
                    r1 = _b.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, snaptrade.authentication.deleteSnapTradeUser({ userId: "test-user-xyz" })];
                case 3:
                    _b.sent();
                    return [3 /*break*/, 6];
                case 4:
                    e_1 = _b.sent();
                    console.log("Verbose Error:", ((_a = e_1.response) === null || _a === void 0 ? void 0 : _a.data) ? JSON.stringify(e_1.response.data) : e_1.message);
                    // Clean up on fail
                    return [4 /*yield*/, snaptrade.authentication.deleteSnapTradeUser({ userId: "test-user-xyz" })];
                case 5:
                    // Clean up on fail
